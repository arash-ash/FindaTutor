...
import edu.bilkent.findatutor.viewholders.SessionViewHolder;

/**
 * Created by arash on 7/21/16.
 */
public class SessionListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Session, SessionViewHolder>(Session.class, R.layout.item_chat,
                SessionViewHolder.class, postsQuery) {
            @Override
